      ...
      <Accordion type="multiple" defaultValue={["start", "trip", "chat"]} className="w-full border-y">
        ...
        <AccordionItem value="roles">
          ...
          <AccordionContent className="space-y-2 text-sm leading-6 text-muted-foreground">
            ...
            <p>Координатор видит все поездки в дашборде и календаре, работает со справочниками и проверяет заявки перед заместителем ГД. Он не меняет суточные или параметры рассылки.</p>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="trip">
          ...
          <AccordionContent className="space-y-4">
            <StepList items={[
              ...
              "Выберите тип: «Плановая» или «Внеплановая». Плановую поездку можно отправить до 25-го числа текущего месяца, если ее начало приходится на следующий месяц. После 25-го числа новые поездки оформляются только как внеплановые.",
        ...
        <AccordionItem value="status">
          ...
          <AccordionContent className="space-y-3 text-sm text-muted-foreground">
            ...
            <div className="flex flex-wrap gap-2">
              <Badge className="bg-emerald-600 hover:bg-emerald-600">Плановая (утверждена ГД)</Badge><span>после подписи реестра координатор подтвердил плановую поездку в системе;</span>
            </div>
            <div className="flex flex-wrap gap-2">
            ...
            <p className="border-t pt-3">Руководители используют раздел «Согласование» по своей очереди. Плановая поездка проходит: руководители → координатор → ЗГД → реестр на подпись ГД → подтверждение координатором. Внеплановая поездка проходит: руководитель → координатор → ЗГД.</p>
          </AccordionContent>
        </AccordionItem>
        ...
        {canViewRegistryGuide && (
          <AccordionItem value="registry">
            ...
            <AccordionContent className="space-y-2 text-sm leading-6 text-muted-foreground">
              ...
              <p>После подписи реестра генеральным директором откройте «Согласование», выберите соответствующие поездки и нажмите «Подтвердить после подписи ГД».</p>
