      ...
      <Accordion type="multiple" defaultValue={["start", "trip", "chat"]} className="w-full border-y">
        ...
        <AccordionItem value="status">
          ...
          <AccordionContent className="space-y-3 text-sm text-muted-foreground">
            ...
            <p className="border-t pt-3">Руководители используют раздел «Согласование» по своей очереди. Плановая поездка проходит: руководители → координатор → ЗГД → реестр на подпись ГД → подтверждение ГД в приложении. Внеплановая поездка проходит: руководитель → координатор → ЗГД.</p>
          </AccordionContent>
        </AccordionItem>
        ...
        {canViewRegistryGuide && (
          <AccordionItem value="registry">
            ...
            <AccordionContent className="space-y-2 text-sm leading-6 text-muted-foreground">
              ...
              <p>После бумажной подписи реестра генеральный директор открывает «Согласование», выбирает соответствующие поездки и нажимает «Подтвердить плановую». Заявки получают статус «Плановая (утверждена ГД)», а новые поездки на этот месяц можно создать только как внеплановые.</p>
